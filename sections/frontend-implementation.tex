...
\begin{wrapfigure}{r}{0.4\textwidth}
    \centering
    \includegraphics[scale=0.4]{pics/all_worlds_teil1_button.PNG}
...
\begin{figure} [h t]
    \centering
    \includegraphics[scale=0.8]{pics/all_worlds_teil2.PNG}
...
\begin{figure} [h t]
    \centering
    \includegraphics[scale=0.8]{pics/all_worlds_teil2_button.PNG}
    \caption{Memorylands editieren}
    \label{fig:all-worlds-memorylands-editieren}
\end{figure}

Nachdem ein Memoryland erstellt wurde, kann es über die Übersicht aufgerufen werden. 
Sobald der Nutzer auf ein Memoryland klickt, erfolgt eine automatische Weiterleitung 
